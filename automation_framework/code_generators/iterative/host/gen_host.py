...
from code_generators.iterative.header_files.include_headers import include_host_headers

from code_generators.iterative.kernel_top.header import gen_top_header

from code_generators.iterative.host.support_host_functions import gen_supporting_host_functions
from code_generators.iterative.host.host_NTT_compute import gen_host_NTT_compute_functions
from code_generators.iterative.host.poly_data_arrange import gen_poly_data_rearrange_functions
from code_generators.iterative.host.TF_data_arrange import gen_TF_data_rearrange_functions
from code_generators.iterative.host.modMul_precomp import gen_modmul_preComp_functions
from code_generators.iterative.host.main import gen_main

####
# This task is to generate BU based on the different modulo reduction method
####
def gen_ntt_iterative_host_code(designParamsVar):
    ...
    code += gen_function_banner(banner_title)
    code += gen_TF_data_rearrange_functions()
    code += "\n"
