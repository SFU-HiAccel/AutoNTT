...
from code_generators.dataflow.header_files.include_headers import include_host_headers

from code_generators.dataflow.kernel_top.header import gen_top_header

from code_generators.dataflow.host.support_host_functions import gen_supporting_host_functions
from code_generators.dataflow.host.host_NTT_compute import gen_host_NTT_compute_functions
from code_generators.dataflow.host.poly_data_arrange import gen_poly_data_rearrange_functions
from code_generators.dataflow.host.TF_data_arrange import gen_TF_data_rearrange_functions
from code_generators.dataflow.host.modMul_precomp import gen_modmul_preComp_functions
from code_generators.dataflow.host.main import gen_main

####
# This task is to generate BU based on the different modulo reduction method
####
def gen_ntt_dataflow_host_code(designParamsVar):
